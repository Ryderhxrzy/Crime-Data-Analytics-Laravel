    ...
    <div class="p-6">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                <i class="fas fa-triangle-exclamation mr-3" style="color: #274d4c;"></i>
                Risk Forecasting
            </h1>
            <p class="text-gray-600">Predictive analytics for crime risk assessment and future incident forecasting</p>
        </div>
