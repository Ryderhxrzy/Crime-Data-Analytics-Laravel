...
// 1. JWTAuthenticate middleware (loads auth-include.php globally)
// 2. Base Controller class (includes auth-include.php)
// 3. DashboardController (validates authentication)
//
// Helper functions available here:
// - getCurrentUser()
// - getUserEmail()
// - getUserRole()
// - getUserDepartment()
