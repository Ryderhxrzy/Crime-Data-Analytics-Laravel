...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $response->header('Content-Security-Policy',
            "default-src 'self'; " .
            "script-src 'self' 'unsafe-inline' {$viteAllowed} https://challenges.cloudflare.com https://cdn.tailwindcss.com https://cdnjs.cloudflare.com https://code.jquery.com https://cdn.jsdelivr.net https://cdn.datatables.net https://unpkg.com https://js.pusher.com https://cdn.jsdelivr.net/npm/leaflet.heat@0.2.0/dist/leaflet-heat.min.js https://maps.googleapis.com https://maps.gstatic.com; " .
